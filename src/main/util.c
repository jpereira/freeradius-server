 ...
 *
 * if the 'name' wasn't found, return the 'default_value'
 */
size_t rad_getsysconf(int name, size_t default_value) {
	long len = sysconf(name);

	return (size_t) (len > 0) ? len : default_value;
}
